Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'mutant',        '~> 0.8.16'
  gem.add_runtime_dependency 'mutant-rspec',  '~> 0.8.16'
  gem.add_runtime_dependency 'procto',        '~> 0.0.3'
  gem.add_runtime_dependency 'rake',          '~> 12.3.0'
  gem.add_runtime_dependency 'reek',          '~> 5.0.2'
  ...
  gem.add_runtime_dependency 'rubocop',       '~> 0.59.0'
